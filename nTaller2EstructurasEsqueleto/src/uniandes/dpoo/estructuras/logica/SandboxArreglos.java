...
public class SandboxArreglos
{
    ...
    {
    	int largo = arregloEnteros.length;
    	int lista[] = new int[largo + 1];
    	
    	for (int i = 0; i < largo; i++) {
    		lista[i] = arregloEnteros[i];
    	}
    ...
    {
    	int largo = arregloCadenas.length;
    	String lista[] = new String[largo + 1];
    	
    	for (int i = 0; i < largo; i++) {
    		lista[i] = arregloCadenas[i];
    	}
    	
    	lista[largo] = cadena;
    	arregloCadenas = lista;
    ...
    public void eliminarEntero( int valor )
    {
    	...
    	int lista[] = new int[arregloEnteros.length - n];
    	
    	int contador = 0;
    	
    	for (int i = 0; i < arregloEnteros.length; i++) {
    		if (arregloEnteros[i] != valor) {
    			lista[contador] = arregloEnteros[i];
    			contador++;
    		}
    	}
    ...
    public void eliminarCadena( String cadena )
    {
    	...
    	String lista[] = new String[arregloCadenas.length - n];
    	
    	int contador = 0;
    	
    	for (int i = 0; i < arregloCadenas.length; i++) {
    		if (arregloCadenas[i] != cadena) {
    			lista[contador] = arregloCadenas[i];
    			contador++;
    		}
    	}
    ...
    {
    	int lista[] = new int[arregloEnteros.length + 1];
    	
    	if(posicion <= 0) {	
    		for (int i = 0; i < arregloEnteros.length ; i++) {
    			lista[i + 1] =  arregloEnteros[i];
    		} 
    		lista[0] = entero;
    		...
    		lista[lista.length - 1] = entero;
    	} else {
    		 for (int i = 0; i < posicion; i++) {
                 lista[i] = arregloEnteros[i];
             }
             lista[posicion] = entero;
    ...
    {
    	int contador = 0;
        boolean[] listaContados = new boolean[arregloEnteros.length];
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        boolean res = Arrays.equals(arreglo1Ordenado, arreglo2Ordenado);
        return res;
    }
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
    	...
    	for (int i = 0; i < lista.length;i++) {
    		lista[i] = (int)(Math.random() * rango) + minimo;
    	}
